  ...
  if (summaryError || !summary || !occupancy || !financials || !maintenance) {
    return (
      <ChartEmptyState
        ...
        description="We encountered an error loading your reporting summary data. Please ensure the backend services are running."
      />
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-bold tracking-tight text-foreground">Admin Global Dashboard</h1>
        <p className="text-sm text-muted-foreground">Consolidated aggregates and financial overview metrics</p>
      </div>
