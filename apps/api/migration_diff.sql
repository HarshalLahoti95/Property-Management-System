...
-- DropForeignKey
ALTER TABLE "RentCharge" DROP CONSTRAINT "RentCharge_ledgerId_fkey";
...
-- DropForeignKey
ALTER TABLE "LedgerBalanceHistory" DROP CONSTRAINT "LedgerBalanceHistory_ledgerId_fkey";

-- DropIndex
DROP INDEX "RentCharge_ledgerId_idx";

-- DropIndex
DROP INDEX "RentCharge_ledgerId_status_idx";

-- DropIndex
DROP INDEX "Payment_ledgerId_idx";

-- AlterTable
ALTER TABLE "RentCharge" DROP COLUMN "ledgerId",
ADD COLUMN     "billingMonth" TIMESTAMP(3) NOT NULL,
ADD COLUMN     "leaseId" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "Payment" DROP COLUMN "ledgerId",
ADD COLUMN     "billingMonth" TIMESTAMP(3) NOT NULL,
ADD COLUMN     "leaseId" TEXT NOT NULL;
...
-- DropTable
DROP TABLE "LedgerBalanceHistory";
